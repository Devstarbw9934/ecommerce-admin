...
import { apiURL } from '../../components/Utile/urls';
...
const ProductList = () => {
    ...
    return (
        <div>  
            <div className="panel">
                <div className="flex md:items-center justify-between md:flex-row flex-col mb-4.5 gap-5">
                    <div className="flex items-center flex-wrap">
                        <button type="button" onClick={() => setModalVisible(!isModalVisible)} className="btn btn-primary btn-sm m-1 ">
                        ...
                        <button type="button"  className="btn btn-primary btn-sm m-1">
                            <IconGallery className="ltr:mr-2 rtl:ml-2" />
                            <NavLink to="/product/images" className="main-logo flex items-center shrink-0">IMAGES</NavLink>
                        </button>
                    </div>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'productDescription', title: 'Description', sortable: true },
                            { accessor: 'sellPrice', title: 'Sell Price', sortable: true },
                            { accessor: 'width', title: 'Width', sortable: true },
                            { accessor: 'weight', title: 'Weight', sortable: true },
                            { accessor: 'fit', title: 'Fit', sortable: true },
                            { accessor: 'thickness', title: 'Thickness', sortable: true },
                            { accessor: 'eternity', title: 'eternity', sortable: true },
                            { accessor: 'diamonWeight', title: 'Diamond Weight', sortable: true },
                            { accessor: 'diamondClarity', title: 'Diamond Clarity', sortable: true },
                            { accessor: 'idunique', title: 'IDunique', sortable: true, hidden: true },
                            { accessor: 'status', title: 'Status', sortable: true },
                            { accessor: 'productImages', title: 'Images', sortable: true, hidden: true },
                        ]}
            ...
            {isModalVisible && <CreateProductModal closeModal={closeModal} />}
            {isUModalVisible && <UpdateProductModal closeUModal={closeUModal} item={updateItem}/>}
        </div>
    );
};
